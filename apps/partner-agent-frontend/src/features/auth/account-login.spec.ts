...
vi.mock('@/api/account-api', () => ({ accountRequest: mocks.request, AccountApiError: class extends Error { constructor(message: string, readonly status: number) { super(message); } } }));
